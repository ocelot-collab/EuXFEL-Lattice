...
v11, phi11, v13, phi13 = beam2rf(
    E1=130e-3, chirp=-2, curvature=222, skewness=28000, n=3, freq=1.3e9, E0=0.0065
)
...
lat = MagneticLattice(i1.cell + i1d.cell, start=i1.ocelot_start, stop=i1d.otrc_64_i1d)
...
navi.add_physics_proc(smooth, i1.ocelot_start, i1.ocelot_start)
# space charge exclude LH chicane and dumb line
navi.add_physics_proc(sc, i1.ocelot_start, i1.a1_1_stop)
navi.add_physics_proc(sc2, i1.a1_1_stop, i1.bl_48i_i1)
navi.add_physics_proc(sc3, i1.qi_50_i1, i1.ensub_62_i1)
# wakes
navi.add_physics_proc(wake, i1.c_a1_1_1_i1, i1.a1_sim_stop)
navi.add_physics_proc(wake_ah1, i1.c3_ah1_1_1_i1, i1.ah_stop)
navi.add_physics_proc(wake_tds, i1.i1_tds_start, i1.i1_tds_stop)
# ibs, optional
# navi.add_physics_proc(ibs, i1_track.start_ocelot, lat.sequence[-1])
