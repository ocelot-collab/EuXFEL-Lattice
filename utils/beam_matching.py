...
lat_a1 = MagneticLattice(
    i1.cell, start=i1.start_ocelot, stop=i1.a1_sim_stop, method={"global": SecondTM}
)
...
lat_m52 = MagneticLattice(
    i1.cell, start=i1.a1_sim_stop, stop=i1.match_52_i1, method={"global": SecondTM}
)
...
constr = {
    i1.match_52_i1: {"beta_x": betx, "beta_y": bety, "alpha_x": alfx, "alpha_y": alfy}
}
match_beam(
    navi_m52.lat,
    constr,
