...
parray_tl_19 = load_particle_array("2019/section_STN10.npz")
show_e_beam(parray_tl_19, figname="TL 2019")
tws_19 = get_envelope(parray_tl_19)

parray_tl = load_particle_array("particles/section_STN10.npz")
show_e_beam(parray_tl, figname="TL")
tws = get_envelope(parray_tl)
print("TL        - 2019   -      current ")
print(f"beta_x {tws_19.beta_x} / {tws.beta_x}")
print(f"beta_y {tws_19.beta_y} / {tws.beta_y}")
print(f"alpha_x {tws_19.alpha_x} / {tws.alpha_x}")
print(f"alpha_y {tws_19.alpha_y} / {tws.alpha_y}")
