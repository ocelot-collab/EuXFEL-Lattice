...
# Drifts
id_26603312_ = Drift(l=1.472401, eid='ID_26603312_')
d_3 = Drift(l=13.047401, eid='D_3')
d_4 = Drift(l=1.15895, eid='D_4')
d_5 = Drift(l=0.15395, eid='D_5')
id_78430094_ = Drift(l=0.16, eid='ID_78430094_')
...
id_60659446_ = Drift(l=2.06072, eid='ID_60659446_')
...
# Lattice 
cell = (id_26603312_, qk_1982_tl, d_3, bpma_1995_tl, d_4, qf_1997_tl, d_5, chy_1997_tl, id_78430094_, 
...
chx_2012_tl, d_17, chy_2012_tl, d_18, cnx_2021_tl, d_19, cny_2021_tl, d_20, bpmd_2022_tl, id_60659446_, 
stsub_2025_tl)
