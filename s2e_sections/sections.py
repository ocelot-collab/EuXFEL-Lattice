...
class A1(SectionTrack):
    def __init__(self, data_dir, *args, **kwargs):
        ...
        sc2 = SpaceCharge(step=1, random_mesh=bool_sc_rand_mesh)
...
class L3(SectionTrack):
    def __init__(self, data_dir, *args, **kwargs):
        ...
        app.taumax = self.init_parameters.get("taumax", 2)
...
class SASE1(SectionTrack):
    def __init__(self, data_dir, *args, **kwargs):
        ...
        self.add_physics_process(wake, start=sase1.vcst40t10_2229_t2, stop=sase1_stop)
...
class T4(SectionTrack):
    def __init__(self, data_dir, *args, **kwargs):
        ...
        sc2 = SpaceCharge(step=40, random_mesh=bool_sc_rand_mesh)
        sc2.nmesh_xyz = self.init_parameters.get("SC_mesh", SCmesh)

        sc_in_bend = SpaceCharge(step=40, random_mesh=bool_sc_rand_mesh)
        sc_in_bend.nmesh_xyz = self.init_parameters.get("SC_mesh", SCmesh)
